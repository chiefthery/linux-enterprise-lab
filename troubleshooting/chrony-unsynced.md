...
Chrony was configured but not successfully synchronizing with any valid time source. In an identity-based environment (FreeIPA / Kerberos), even small time drift breaks:
